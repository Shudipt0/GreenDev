    ...
    <section className="w-full py-8 lg:py-16 ">
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-between items-center ">
        ...
        <div className="w-full lg:w-[540px] col-span-1 space-y-4 lg:space-y-8">
          ...
          <p className="text-[22px] text-gray-400 leading-tight" >Our team of digital product creators and Tch Bring Skilled will take your idea to the next level and help you with your product</p>
        </div>
        {/* right side */}
