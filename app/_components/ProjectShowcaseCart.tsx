...
const ProjectShowcaseCart = ({ item }: { item: ShowcaseItem }) => {
  ...
  return (
          ...
          <div className="lg:w-[540px] mt-10 md:mt-0 space-y-6 text-start">
            ...
            <h1 className="text-[22px] lg:text-[40px] text-black font-bold leading-tight">
              {title}
            </h1>
            ...
            <Link href={link} >
              <button className="flex items-center gap-3 text-sm text-blue-500 px-5 py-3 border-2 border-blue-500 rounded font-semibold mt-3 ">
                Check the project
                <span>
